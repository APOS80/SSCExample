                       ...
                       (when (> k -1)
                        (seesaw.graphics/anti-alias
                         (seesaw.graphics/draw g
                          ...
                          (seesaw.graphics/style :foreground (seesaw.color/color (rand-int 255) (rand-int 255) (rand-int 255) (rand-int 255)) 
...
(defn behave [root]
  (let [canvas (seesaw.core/select root [:#canvas])
        ...
        exited (seesaw.core/listen canvas :mouse-exited (fn [e] (seesaw.core/config! canvas :background :black)
                                                                (dosync (ref-set xy []))
